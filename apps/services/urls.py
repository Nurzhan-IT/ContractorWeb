...
urlpatterns = [
    ...
    path('construction-website-design/', views.ConstructionWebsiteDesignView.as_view(), name='construction_website_design'),
    path('general-contractor-website-design/', views.GeneralContractorWebsiteDesignView.as_view(), name='general_contractor_website_design'),
    ...
    path('electrical-contractor-website-design/', views.ElectricalContractorWebsiteDesignView.as_view(), name='electrical_contractor_website_design'),
    ...
    path('contractor-lead-generation/', views.ContractorLeadGenerationView.as_view(), name='contractor_lead_generation'),
    path('construction-lead-generation/', views.ConstructionLeadGenerationView.as_view(), name='construction_lead_generation'),
]
