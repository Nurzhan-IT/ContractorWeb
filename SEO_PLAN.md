...
- [x] Зарегистрировать агентство на Clutch.co
- [ ] Зарегистрировать агентство на DesignRush.com
- [x] Проверить PageSpeed Insights, устранить критические проблемы
- [ ] Написать 2 новые статьи с long-tail ключевыми словами
- [x] Добавить внутренние ссылки между существующими 5 статьями
- [x] Проверить JSON-LD через Rich Results Test


Нужно сделать три вещи чтобы профиль опубликовали:

1. Edit Profile — заполнить полностью

Описание агентства на английском
Специализация: Web Design, SEO
Минимальный бюджет проекта
Ссылка на сайт contractorwebdev.com
Страна, часовой пояс
2. Portfolio — добавить хотя бы 1 проект

Можно добавить contractorwebdev.com как демо-проект
Описание, скриншоты, какие услуги были оказаны
3. Request a Review — запросить отзыв

Clutch сам пишет на email клиента и собирает отзыв
Без хотя бы одного отзыва профиль либо не публикуется, либо ранжируется в самом низу
Если есть хоть один прошлый клиент — добавь его сейчас
