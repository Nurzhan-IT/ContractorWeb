...
from plumbing.views import PlumbingQuotePDFView, PlumbingQuoteSubmitView
...
urlpatterns = [
    ...
    path(
        'plumbing/<slug:business_slug>/quote/submit/', PlumbingQuoteSubmitView.as_view(), name='plumbing_quote_submit'
    ),
